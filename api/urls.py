...
urlpatterns = [
    ...
    # path('user_pipelines/open_logs/<str:log_file>', views.UsersPipelinesOpenLogsView.as_view()),
    path('user_pipelines/results', views.UsersPipelinesResultsView.as_view()),
    # path('user_pipelines/open_results/<str:results_file>', views.UsersPipelinesOpenResultsView.as_view()),
